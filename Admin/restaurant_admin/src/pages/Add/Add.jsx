...
import axios from 'axios' //dung axios để gửi yêu cầu HTTP


const Add = () => {

    const url = "" //Thêm đường dẫn API của database vào đây
        ...
        <form className='flex-col' onSubmit={onSubmitHandler}>
            <div className="add-image-upload flex-col">
                ...
                <label htmlFor="food-image">
                    <img className='inserted-image' src={image?URL.createObjectURL(image):assets.upload_area} alt="Upload Area" />
                </label>
                <input onChange={(e) => setImage(e.target.files[0])} type="file" id="food-image" hidden required />
            </div>
