    ...
    return (
        <>
            ...
            <div className="text-box">
                ...
                <p>Take a look at our <Link to="#menu" className="btn">MENU</Link></p>
            </div>
            ...
            <footer>
                ...
                <div className="footer-section social-icons">
                    <h3>Follow Us</h3>
                    <a href="https://facebook.com" target="_blank">Facebook <i className="fi fi-brands-facebook"></i></a><br />
                    <a href="https://instagram.com" target="_blank">Instagram <i className="fi fi-brands-instagram"></i></a><br />
                    <a href="https://youtube.com" target="_blank">Youtube <i className="fi fi-brands-youtube"></i></a>
                </div>
                <div className="footer-section">
                    <h3>Opening Hours</h3>
